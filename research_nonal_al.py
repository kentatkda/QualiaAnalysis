...
def run_nonal_al_all(
    ...
    all_embeddings, all_distances = run_all_gwot(
        subjects=subjects,
        emotions=emotions,
        colors=colors,
    ...
    return all_original_embeddings, all_embeddings, distances_df
...
def run_calculate_dissimilarity(
...
def run_all_gwot(
    ...
    return all_embeddings, all_distances
